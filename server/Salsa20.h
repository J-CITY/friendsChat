...
extern std::map<int, std::string> userKeys;
...
//                std::cout<< i/4 << " " << i-(i/4)*4 << " !!\n";
                //std::cout << pos << "\n";
                //std::cout<< textToIntVec[i] << "\n";
                //std::cout << (i/4)%16 << " " << (i-(i/4)*4)%16 << "\n";
                //std::cout << " " << mat.mat[(i/4)%4][(i-(i/4)*4)%4] << "\n";
                // << " " << (textToIntVec[i]^mat.mat[i/4][i-(i/4)*4]) << " !!\n";
                textToIntVec[i] ^= mat.mat[(i/4)%4][(i-(i/4)*4)%4];
